...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <form role="form" method="POST" action="{{ url('kelola-jadwal/add') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_pinjam" class="form-control" id="exampleInputEmail1" placeholder="Tanggal Pinjam">
                        </div>                    

                        <div class="form-group">
                            <label for="exampleInputEmail1">Waktu Pinjam</label>
                            <input type="text" name="waktu_pinjam" class="form-control" id="exampleInputEmail1" placeholder="Waktu Pinjam">
                        </div> 
